...
# Vendored into QuACK from CUTLASS example:
#   examples/python/CuTeDSL/cute/blackwell_geforce/kernel/blockscaled_gemm/
#     dense_blockscaled_gemm_persistent_cooperative.py
# SM120 (Blackwell GeForce / RTX PRO 6000) warp-level block-scaled GEMM.
# This is the warp-MMA (mma.sync.kind::mxf8f6f4) blockscaled path; sm100 uses
# tcgen05/TMEM and cannot share this code.
...
from quack.sm120_blockscaled_dispatch import (
    FP4_SHIFT_BITS,
    make_ldmatrix_atom,
